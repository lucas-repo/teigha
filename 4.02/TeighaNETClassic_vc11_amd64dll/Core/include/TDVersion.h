...
#define TD_PRODUCT_VER_STR_S   "4.02.2.0"
#define TD_PRODUCT_VER_STR_W  L"4.02.2.0"

//Changed in VersionInfo to TD_PRODUCT_NAME_S " " TD_PRODUCT_VER_STR_S
//That need for NET and ActiveX
#define TD_BUILD_COMMENTS_S    "Teigha\xAE 4.02.2.0"
#define TD_BUILD_COMMENTS_W   L"Teigha\x00AE 4.02.2.0"


#define TD_TYPELIB_VER(MAJ,MIN) version(##MAJ##.##MIN##)

#define TEIGHA_BUILD_NUMBER 28378
#define TEIGHA_MAIN_SVN_REVISION 3237
#define TEIGHA_CORE_SVN_REVISION 163541
#define TEIGHA_DGN_SVN_REVISION 5233
#define TEIGHA_ARCHITECTURE_SVN_REVISION 68577
#define TEIGHA_CIVIL_SVN_REVISION 68491
#define TEIGHA_NET_SVN_REVISION 1382
#define TEIGHA_JAVA_SVN_REVISION 1392
#define TEIGHA_MECHANICAL_SVN_REVISION 1102
#define TEIGHA_PRC_SVN_REVISION 1686
#define TEIGHA_BIM_SVN_REVISION 4010
#define TEIGHA_CLOUD_SVN_REVISION 3815
