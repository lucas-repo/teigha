...
/**
  ...
  <b>Note: </b>If Null then CLAYER is used for new hatch entities.
...
/**
  ...
  DIMLAYER stores a default layer for new dimensions.
...
/**
  ...
  The ISAVEPERCENT variable stores total amount of the free space tolerated in the file.
