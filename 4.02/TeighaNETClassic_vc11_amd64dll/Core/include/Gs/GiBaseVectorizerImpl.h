...
public:
  ...
  */
  ...
  /*virtual*/ bool pushLineweightOverride(const OdGiLineweightOverride *pOverride); // @@@tmp:#22542 : make method virtual
  /*virtual*/ void popLineweightOverride(); // @@@tmp:#22542 : make method virtual
...
protected:
  ...
  friend class OdGiLineweightOverrideImpl; // @@@tmp:#22542
  friend class OdGiLineweightOverrideManager; // @@@tmp:#22542
  struct LineweightOverrideCallerRedirectFunction { // @@@tmp:#22542
    virtual void updateLineweightOverride(const OdGiLineweightOverride &lwdOverride) = 0; // @@@tmp:#22542
  };
  void installLineweightOverrideCallerRedirectFunction(LineweightOverrideCallerRedirectFunction *pFunc); // @@@tmp:#22542
  template <typename CallerClass> class LineweightOverrideCallerRedirectFunctionImpl : public LineweightOverrideCallerRedirectFunction
  { CallerClass *m_pCaller; public: LineweightOverrideCallerRedirectFunctionImpl(CallerClass *pCaller) : m_pCaller(pCaller) {}
    virtual void updateLineweightOverride(const OdGiLineweightOverride &lwdOverride) { m_pCaller->updateLineweightOverride(lwdOverride); } };
#define ODGS_INSTALL_LWDOVERRIDECFUNC(pVect, vectClass, pThis) \
  pVect->installLineweightOverrideCallerRedirectFunction(new LineweightOverrideCallerRedirectFunctionImpl<vectClass>(pThis));
  // eof @@@tmp:#22542
};
