...
protected:
  ...
  enum
  {
    ...
    // First 8 bits for lineweights, and other 2 bits for lineweights classifications
    kLightSourceOwner = (1 << 10), // owning at least one light source

    kLastEntFlag        = kLightSourceOwner
  };
  // m_markToSkipFlags
  enum
  {
...
public:
  ...
  */
  ...
  virtual
#endif
  OdGsEntityNode::MetafilePtr regenMetafile(OdGsUpdateContext &ctx, OdUInt32 vpDepFlags);
